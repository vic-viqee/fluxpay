...
class User(Document):
    ...
    google_id: Optional[str] = Field(default=None, unique=True, sparse=True, alias="googleId")
    password_reset_token: Optional[str] = Field(default=None, alias="passwordResetToken")
    password_reset_expires: Optional[datetime] = Field(default=None, alias="passwordResetExpires")
    ...
    business_till_or_paybill: Optional[str] = Field(default=None, alias="businessTillOrPaybill")
    business_phone_number: str = Field(alias="businessPhoneNumber")
    preferred_payment_method: str = Field(default="M-Pesa STK Push", alias="preferredPaymentMethod")
    business_description: Optional[str] = Field(default=None, alias="businessDescription")
    logo_url: Optional[str] = Field(default=None, alias="logoUrl")
    plan: Optional[str] = None
    role: Literal["user", "admin"] = "user"
    service_type: Literal["subscription", "gateway", "both"] = Field(default="both", alias="serviceType")
