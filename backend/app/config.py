...
class Settings(BaseSettings):
    ...
    allowed_origins: str = "http://localhost:5173,http://localhost:3000,https://fluxpay-frontend.onrender.com,https://fluxpay.onrender.com,https://anything-marketplace-web.onrender.com"
