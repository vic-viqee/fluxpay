...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen"> 
      {/* Note: I removed the <aside> Sidebar here because your App likely already has one */}
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div>
            ...
            <h2 className="text-lg font-medium text-gray-600 mt-1">Overview</h2>
          </div>

          <div className="flex space-x-3 mt-4 md:mt-0">
             {/* "Export" is now just a button, keeping it simple */}
            <button className="text-gray-600 hover:text-gray-900 font-medium px-3 py-2">Export</button>
            
            <button 
              onClick={handleSimulateStkPush} 
              disabled={stkLoading}
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow transition font-medium"
            >
            ...
            <button 
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow transition font-medium"
            >
              Add Subscription
            </button>
          </div>
