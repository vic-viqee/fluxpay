          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-12 text-center">
              <button 
                ...
                className="px-6 py-3 text-lg font-medium text-white bg-main border border-transparent rounded-md shadow-lg hover:bg-blue-500 transition-colors disabled:bg-surface-bg disabled:cursor-not-allowed"
              >
                {getButtonText()}
              </button>
            </div>
        ...
        <section className="py-16 md:py-24 bg-surface-bg">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold text-white">
                More than just payments. <span className="text-transparent bg-clip-text bg-gradient-to-r from-main to-accent">A full financial toolkit.</span>
              </h2>
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-main bg-opacity-20 text-main rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white">Automated Reconciliation</h3>
                  <p className="text-gray-400 mt-1">Every transaction is automatically tracked and matched. No more manual spreadsheet work.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-main bg-opacity-20 text-main rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white">Instant Branded Receipts</h3>
                  <p className="text-gray-400 mt-1">Send beautiful, professional receipts to your customers instantly via SMS or WhatsApp.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-main bg-opacity-20 text-main rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white">Growth-Friendly</h3>
                  <p className="text-gray-400 mt-1">Our hybrid model means we only make money when you do. Perfect for scaling businesses.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 bg-main bg-opacity-20 text-main rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-1">All data is encrypted and stored securely. We are fully PCI-DSS compliant.</p>
                </div>
              </div>
            </div>
          </div>
